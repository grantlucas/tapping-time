...
export function scoreDay(tempLow, tempHigh) {
...
export function findBestWindow(days) {
  let bestRun = null;
  let currentRun = null;
  ...
  for (const day of days) {
    if (day.score >= 2) {
      // Good or Excellent
      if (!currentRun) {
        currentRun = { start: day.date, days: [day], totalScore: day.score };
      } else {
